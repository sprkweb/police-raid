...
2. **Host-based P2P:**
   - One player's browser acts as the "Host" (server).
...
- **Build Tool:** Vite
- **Language:** TypeScript
- **Network Library:** PeerJS

## High-level Components
- **NetworkService (Abstract):** Handles connecting to the signaling server, creating rooms, joining rooms, and sending/receiving messages.
